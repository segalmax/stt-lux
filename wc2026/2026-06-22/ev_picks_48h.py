#!/usr/bin/env python3
"""WC2026 bookies-grounded EV picks — 48h window from 2026-06-22 07:02 IDT.

Upcoming matches in the next 48h (kickoffs in IDT; ET+7):
  1. Argentina v Austria       20:00 IDT Jun 22  (1pm  ET Jun 22)
  2. France v Iraq             00:00 IDT Jun 23  (5pm  ET Jun 22)
  3. Norway v Senegal          03:00 IDT Jun 23  (8pm  ET Jun 22)
  4. Jordan v Algeria          06:00 IDT Jun 23  (11pm ET Jun 22)
  5. Portugal v Uzbekistan     20:00 IDT Jun 23  (1pm  ET Jun 23)
  6. England v Ghana           23:00 IDT Jun 23  (4pm  ET Jun 23)
  7. Panama v Croatia          02:00 IDT Jun 24  (7pm  ET Jun 23)
  8. Colombia v Congo DR       05:00 IDT Jun 24  (10pm ET Jun 23)

All group stage: direction 1 pt, exact 3 pts -> EV = P(class) + 2*P(exact).
bet365 odds via kickoff.co.uk (fetched 2026-06-22 morning IDT).
...
MATCHES = [
    dict(
        ...
        ko="20:00 IDT Jun 22",
        o1x2=(1.57, 3.20, 6.67),
        cs={(1, 0): 6.50, (2, 0): 7.00, (1, 1): 8.00, (2, 1): 9.00,
            (3, 0): 11.00, (0, 0): 10.00, (3, 1): 13.00, (0, 1): 17.00,
            (1, 2): 23.00, (2, 2): 21.00, (4, 0): 21.00, (4, 1): 26.00,
            (3, 2): 29.00, (0, 2): 41.00, (5, 0): 41.00},
    ),
    dict(
        slug="france_v_iraq", home="France", away="Iraq",
        ko="00:00 IDT Jun 23",
        o1x2=(1.06, 12.00, 41.00),
        cs={(3, 0): 5.50, (2, 0): 6.00, (4, 0): 6.50, (1, 0): 9.00,
            (5, 0): 10.00, (3, 1): 15.00, (2, 1): 17.00, (4, 1): 19.00,
            (6, 0): 19.00, (1, 1): 23.00, (5, 1): 29.00, (0, 0): 19.00,
            (7, 0): 34.00, (6, 1): 41.00, (3, 2): 51.00},
    ),
    dict(
        slug="norway_v_senegal", home="Norway", away="Senegal",
        ko="03:00 IDT Jun 23",
        o1x2=(2.25, 3.60, 3.125),
        cs={(1, 1): 7.00, (1, 0): 8.50, (2, 1): 10.00, (0, 1): 10.00,
    ...
    dict(
        ...
        ko="06:00 IDT Jun 23",
        o1x2=(4.75, 4.33, 1.57),
        cs={(0, 1): 7.00, (0, 2): 7.50, (1, 1): 8.50, (1, 2): 9.00,
            (0, 3): 11.00, (0, 0): 11.00, (1, 3): 13.00, (1, 0): 15.00,
            (2, 1): 19.00, (2, 2): 21.00, (0, 4): 23.00, (1, 4): 26.00,
            (2, 3): 29.00, (2, 0): 34.00, (0, 5): 41.00},
    ),
    dict(
        slug="portugal_v_uzbekistan", home="Portugal", away="Uzbekistan",
        ko="20:00 IDT Jun 23",
        o1x2=(1.22, 6.50, 13.00),
        cs={(2, 0): 6.00, (3, 0): 7.50, (1, 0): 8.00, (2, 1): 10.00,
            (4, 0): 11.00, (3, 1): 12.00, (1, 1): 13.00, (4, 1): 19.00,
            (0, 0): 15.00, (5, 0): 21.00, (0, 1): 29.00, (2, 2): 29.00,
    ...
    dict(
        ...
        cs={(2, 0): 5.50, (1, 0): 7.00, (3, 0): 7.00, (2, 1): 11.00,
            (4, 0): 11.00, (1, 1): 13.00, (3, 1): 13.00, (0, 0): 15.00,
            (4, 1): 21.00, (5, 0): 21.00, (0, 1): 23.00, (2, 2): 34.00,
            (5, 1): 34.00, (1, 2): 34.00, (3, 2): 41.00},
    ),
    dict(
        slug="panama_v_croatia", home="Panama", away="Croatia",
        ko="02:00 IDT Jun 24",
        o1x2=(6.50, 4.10, 2.00),
        cs={(0, 1): 6.50, (0, 2): 7.00, (1, 1): 8.00, (1, 2): 9.00,
            (0, 3): 11.00, (0, 0): 10.00, (1, 3): 13.00, (1, 0): 17.00,
            (2, 1): 21.00, (2, 2): 21.00, (0, 4): 21.00, (1, 4): 26.00,
            (2, 3): 29.00, (2, 0): 34.00, (0, 5): 41.00},
    ),
    dict(
        ...
        ko="05:00 IDT Jun 24",
        o1x2=(1.50, 3.10, 5.50),
        cs={(1, 0): 4.50, (2, 0): 5.50, (1, 1): 7.50, (2, 1): 8.50,
            (0, 0): 7.50, (3, 0): 10.00, (0, 1): 15.00, (3, 1): 15.00,
            (1, 2): 23.00, (4, 0): 21.00, (2, 2): 26.00, (4, 1): 34.00,
            (0, 2): 34.00, (3, 2): 41.00, (5, 0): 41.00},
    ),
]
...
# ---- summary markdown ----
md = ["# WC2026 EV picks — 48h window from 2026-06-22 07:02 IDT\n"]
